...
class SourcesResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> SourcesResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/graphor-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> SourcesResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/graphor-python#with_streaming_response
        """
